    ...
    return (
        <div className="hero min-h-screen bg-base-200 p-4">
            <div className="hero-content flex-col lg:flex-row">
                ...
                <img src={parts} className="w-1/2 border-8 border-white right-5 top-1/2 absolute rounded-lg shadow-2xl" />
                </div>
                <div className='lg:w-1/2'>
                    ...
                    <p className="pb-6">the majority have suffered alteration in some form, by injected humour, or randomized words which do not look even slightly believable. </p>
